# РЕШЕНО `Mocking (задача со звёздочкой)`

## первую и вторую задачу не удалял
...
В качестве шаблона вы можете использовать [готовый проект](https://github.com/RT-Vinsent/ajs-homeworks/tree/ajs8/ci-template).
